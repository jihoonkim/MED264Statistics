...
Below, take the comments out to run in R

```{r}

# myPackages = c( "CompQuadForm", "ggplot2", "irr", "knitr", "minqa", "prLogistic", "pROC", "pwr", "ResourceSelection",  "survival")
...
### Example: logistic regression, treatment for drug abuse
